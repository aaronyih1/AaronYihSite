    ...
    return(
    	<div>
    		...
    		<div style = {containerStyle}>
    			...
    			<p style = {paragraphStyle}>Balance is cliché. I don’t mean the word; I mean the concept.  Clichés exist because they demonstrate concepts clearly.  When I used spotlight on my laptop to find the definition of balance, I got a noun with six different meanings—go ahead and try it yourself if you’re on a mac. Just as you cannot appreciate the flavors of a red wine by examining its sediment at the bottom of the bottle, you cannot understand balance by reading its definition. </p>
